...
import AccordionGroup from '@/components/Slider/components/AccordionGroup'
import Accordion from '@/components/Slider/components/Accordion'
...
const Questions = () => {
    ...
    return (
        <Section title="Frequently Asked Questions" titleId="questions-title" description="Got questions? We've got answers! Check out our FAQ section to find answers to the most common questions about StreamVibe." actions={(
