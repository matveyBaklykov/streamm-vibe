            ...
            <div className="movie-details__main">
                ...
                <div className="movie-details__panel">
                    <header className="movie-details__panel-header">
                        ...
                        <SliderNavigation id={castSliderNavigationId} hasPagination={false} buttonMode="black-08" mode="rounded"/>
                    </header>
                    <Slider
                ...
                <div className="movie-details__panel movie-details__panel--large-gap-y">
                    ...
                    <Slider navigationMode="rounded" isNavigationHiddenMobile={false} hasScrollbarOnMobile={false}
                    sliderParams={{
                        slidesPerView: 2,
                        slidesPerGroup: 2,
                        breakpoints: {
                ...
                <div className="movie-details__panel">
                    <div className="movie-details__groups">
                        ...
                        <div className="movie-details__group">
                            ...
                            <PersonCard name="Rishab Shetty" subtitle="From India" imgSrc='/src/assets/images/people/director.jpg'
                            />
                        </div>
                        <div className="movie-details__group">
                            <h3 className="movie-details__title">
                            ...
                            <PersonCard name="B. Ajaneesh Loknath" subtitle="From India" imgSrc='/src/assets/images/people/music.jpg'
                            />
                        </div>
                    </div>
                </div>
