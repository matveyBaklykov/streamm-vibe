...
const PlansComparison = () => {
    ...
    return (
        <Section title="Compare our plans and find the right one for you" desciption="StreamVibe offers three different plans to fit your needs: Basic, Standard, and Premium. Compare the features of each plan and choose the one that's right for you." titleId="plans-comparison-title">
