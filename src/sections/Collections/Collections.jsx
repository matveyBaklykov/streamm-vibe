...
const Collections = () => {
    return (
        <Tabs className="collections container" title="collections" isEnableOnlyonMobile items={collectionGroups.map((collectionGroup, index) => (
            {
                ...
                children: (
                    <div className='collections__group'>
                        ...
                        {collectionGroup.items.map((collectionItem, index) => {
                            ...
                            return (
                                <Section className="collections__section" title={title} titleId={titleId} actions={(
                                    <SliderNavigation id={sliderNavigationId} mode="tile"/>
                                )} isActionsHiddenOnMobile key={index}>
                                    <Slider sliderParams={sliderParams} navigationTargetElementId={sliderNavigationId} isBeyondTheViewportOnMobileS>
